...
| --- | --- |
| **Cell-iSCAT** | Research platform in development for intracellular particle tracking, trajectory analysis, and spatially resolved cell-dynamics measurements. |
| [**CellRaQ**](https://github.com/PabloAu/CellRaQ) | Tools for cellular RNA quantification in experimental imaging workflows. |
...
- Quantitative microscopy and live-cell biophysics
- Intracellular transport, physical-state dynamics, and spatial organization
- Single-particle and single-molecule tracking
